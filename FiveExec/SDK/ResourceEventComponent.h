...
namespace fx
{
	...
	class RESOURCES_CORE_EXPORT ResourceEventComponent : public fwRefCountable, public fx::IAttached<fx::Resource>
	{
	private:
		Resource* m_resource;
	...
	class RESOURCES_CORE_EXPORT ResourceEventManagerComponent : public fwRefCountable, public fx::IAttached<fx::ResourceManager>
	{
	private:
		struct EventData
		{
